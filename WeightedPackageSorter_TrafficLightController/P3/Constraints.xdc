...
set_property PACKAGE_PIN V19 [get_ports {lightw[1]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {lightw[1]}]
set_property PACKAGE_PIN W18 [get_ports {lightw[0]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {lightw[0]}]
set_property PACKAGE_PIN U15 [get_ports {lightb[2]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {lightb[2]}]
set_property PACKAGE_PIN U14 [get_ports {lightb[1]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {lightb[1]}]
set_property PACKAGE_PIN V14 [get_ports {lightb[0]}]                                        
