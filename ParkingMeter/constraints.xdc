...
## LEDs
    ...
    set_property PACKAGE_PIN U2 [get_ports {digit_enable[0]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {digit_enable[0]}]
    set_property PACKAGE_PIN U4 [get_ports {digit_enable[1]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {digit_enable[1]}]
    set_property PACKAGE_PIN V4 [get_ports {digit_enable[2]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {digit_enable[2]}]
    set_property PACKAGE_PIN W4 [get_ports {digit_enable[3]}]                    
...
set_property PACKAGE_PIN T18 [get_ports BU]                        
    set_property IOSTANDARD LVCMOS33 [get_ports BU]
set_property PACKAGE_PIN W19 [get_ports BL]                        
    set_property IOSTANDARD LVCMOS33 [get_ports BL]
set_property PACKAGE_PIN T17 [get_ports BR]                        
    set_property IOSTANDARD LVCMOS33 [get_ports BR]
set_property PACKAGE_PIN U17 [get_ports BD]                        
